...
export const REPOSWITHOUTRECENTCOMMIT = gql`
         query getReposWiithoutRecentCommits($name: String!, $first: Int, $after: String) {
           user(login: $name) {
             login
             repositories(
               after: $after
...
const RECENTREPOWithCOMMIT = gql`
  query getRepoWithRecentCommit {
